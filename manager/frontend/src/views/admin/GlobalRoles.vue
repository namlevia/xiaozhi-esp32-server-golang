<template>
  <div class="roles-page">
        ...
        <el-card class="role-card" shadow="hover">
                ...
                <template #dropdown>
                  <el-dropdown-menu>
                    ...
                    <el-dropdown-item command="set-default" :disabled="role.is_default">
                      ...
                      {{ role.is_default ? t('role.defaultSet') : t('role.setDefault') }}
                    </el-dropdown-item>
          ...
          <div class="role-content">
            ...
            <div class="role-config">
              ...
              <el-tag v-if="role.is_default" size="small" type="warning">{{ t('role.defaultRole') }}</el-tag>
    ...
    <el-empty v-if="!loading && roles.length === 0" :description="t('role.emptyGlobal')">
      <el-button type="primary" @click="showCreateDialog = true">{{ t('role.createFirstGlobal') }}</el-button>
    </el-empty>

    <el-dialog
      v-model="showCreateDialog"
      :title="editingRole ? t('role.editGlobal') : t('role.createGlobal')"
      width="800px"
      ...
      >
        <div class="dialog-sections">
          <section class="dialog-section">
            ...
            <el-form-item :label="t('role.sortOrder')">
              <el-input-number
            ...
            <el-form-item :label="t('role.defaultRoleField')">
...
const setDefaultRole = async (role) => {
  ...
  try {
    ...
    ElMessage.success(t('role.defaultUpdated'))
    await loadRoles()
  } catch (error) {
    ElMessage.error(`${t('role.defaultUpdateFailed')}: ${error.response?.data?.error || error.message}`)
  }
}

const deleteRole = async (id) => {
  try {
    await ElMessageBox.confirm(t('role.confirmDelete', { name: t('role.globalRole') }), t('device.confirmDeleteTitle'), {
