...
- **Truy cập LAN**: `http://<IP server>:1234/`
...
```bash
# Ubuntu/Debian (ufw)
sudo ufw allow 1234/tcp  # Backend quản trị
sudo ufw allow 1233/tcp  # WebSocket
sudo ufw allow 1235/tcp  # MQTT
sudo ufw allow 1236/udp  # UDP

# CentOS/RHEL (firewalld)
sudo firewall-cmd --permanent --add-port=1234/tcp
sudo firewall-cmd --permanent --add-port=1233/tcp
sudo firewall-cmd --permanent --add-port=1235/tcp
sudo firewall-cmd --permanent --add-port=1236/udp
